...
INSERT INTO Trip (ID, Emp_ID, To_City, Dep_Date, Return_Date,Est_Cost) VALUES ('2', '2000','CHICAGO',                TO_DATE('15/06/2018', 'DD/MM/YYYY'), TO_DATE('20/05/2018', 'DD/MM/YYYY'),'1500.00');
INSERT INTO Trip (ID, Emp_ID, To_City, Dep_Date, Return_Date,Est_Cost) VALUES ('3', '3000','NEW ORLEANS',            TO_DATE('13/02/2013', 'DD/MM/YYYY'), TO_DATE('20/02/2013', 'DD/MM/YYYY'),'1200.00');
